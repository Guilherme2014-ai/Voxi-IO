...
export type Chat = Node & {
  ...
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<Chat>;
  /** List of Chat versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID'];
  /** This chat messages */
 ...
 *
 */
export type ChatDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
 ...
 *
 */
export type ChatPublishedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
 ...
 *
 */
export type ChatScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type ChatCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']>;
  messages?: InputMaybe<MessageCreateManyInlineInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};

export type ChatCreateManyInlineInput = {
  /** Connect multiple existing Chat documents */
  connect?: InputMaybe<Array<ChatWhereUniqueInput>>;
  /** Create and connect multiple existing Chat documents */
  create?: InputMaybe<Array<ChatCreateInput>>;
};

export type ChatCreateOneInlineInput = {
  /** Connect one existing Chat document */
  connect?: InputMaybe<ChatWhereUniqueInput>;
  /** Create and connect one Chat document */
...
/** Identifies documents */
export type ChatManyWhereInput = {
  /** Logical AND on all given filters. */
...
export type ChatUpdateInput = {
  ...
  messages?: InputMaybe<MessageUpdateManyInlineInput>;
};

export type ChatUpdateManyInlineInput = {
  /** Connect multiple existing Chat documents */
  connect?: InputMaybe<Array<ChatConnectInput>>;
  /** Create and connect multiple Chat documents */
  create?: InputMaybe<Array<ChatCreateInput>>;
  /** Delete multiple Chat documents */
  delete?: InputMaybe<Array<ChatWhereUniqueInput>>;
  /** Disconnect multiple Chat documents */
  disconnect?: InputMaybe<Array<ChatWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Chat documents */
  set?: InputMaybe<Array<ChatWhereUniqueInput>>;
  /** Update multiple Chat documents */
  update?: InputMaybe<Array<ChatUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Chat documents */
  upsert?: InputMaybe<Array<ChatUpsertWithNestedWhereUniqueInput>>;
};

export type ChatUpdateManyInput = {
  /** No fields in updateMany data input */
  _?: InputMaybe<Scalars['String']>;
};

export type ChatUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: ChatUpdateManyInput;
  /** Document search */
  where: ChatWhereInput;
};

export type ChatUpdateOneInlineInput = {
  /** Connect existing Chat document */
  connect?: InputMaybe<ChatWhereUniqueInput>;
  /** Create and connect one Chat document */
  create?: InputMaybe<ChatCreateInput>;
  /** Delete currently connected Chat document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected Chat document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single Chat document */
  update?: InputMaybe<ChatUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Chat document */
  upsert?: InputMaybe<ChatUpsertWithNestedWhereUniqueInput>;
};

export type ChatUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
...
export type ChatUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: ChatUpsertInput;
  /** Unique document search */
  where: ChatWhereUniqueInput;
};
...
/** References Chat record uniquely */
...
export type ContactManyWhereInput = {
  ...
  chats_every?: InputMaybe<ChatWhereInput>;
  chats_none?: InputMaybe<ChatWhereInput>;
  chats_some?: InputMaybe<ChatWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
  ...
  profile_picture_url?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  profile_picture_url_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  profile_picture_url_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  profile_picture_url_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  profile_picture_url_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  profile_picture_url_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  profile_picture_url_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  profile_picture_url_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  profile_picture_url_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  profile_picture_url_starts_with?: InputMaybe<Scalars['String']>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type ContactUpdateInput = {
  bio?: InputMaybe<Scalars['String']>;
  chats?: InputMaybe<ChatUpdateManyInlineInput>;
  name?: InputMaybe<Scalars['String']>;
  number?: InputMaybe<Scalars['Int']>;
  profile_picture_url?: InputMaybe<Scalars['String']>;
  username?: InputMaybe<Scalars['String']>;
...
export type Message = Node & {
  __typename?: 'Message';
  /** The username from the contact who sent the message */
  contactSenderId: Scalars['String'];
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<Message>;
...
/** The chats messages */
export type MessageCreatedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};


/** The chats messages */
export type MessageDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
...
/** The chats messages */
export type MessagePublishedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};


/** The chats messages */
export type MessageScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The chats messages */
export type MessageUpdatedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type MessageCreateInput = {
  cl5po8uvy2cr601ul2mfa2356?: InputMaybe<ChatCreateManyInlineInput>;
  contactSenderId: Scalars['String'];
  createdAt?: InputMaybe<Scalars['DateTime']>;
  text: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type MessageCreateManyInlineInput = {
...
export type MessageCreateOneInlineInput = {
  /** Connect one existing Message document */
  connect?: InputMaybe<MessageWhereUniqueInput>;
  /** Create and connect one Message document */
...
/** Identifies documents */
export type MessageManyWhereInput = {
  /** Logical AND on all given filters. */
  ...
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  contactSenderId?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  contactSenderId_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  contactSenderId_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  contactSenderId_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  contactSenderId_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  contactSenderId_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  contactSenderId_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  contactSenderId_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  contactSenderId_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  contactSenderId_starts_with?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum MessageOrderByInput {
  ContactSenderIdAsc = 'contactSenderId_ASC',
  ContactSenderIdDesc = 'contactSenderId_DESC',
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
export type MessageUpdateInput = {
  cl5po8uvy2cr601ul2mfa2356?: InputMaybe<ChatUpdateManyInlineInput>;
  contactSenderId?: InputMaybe<Scalars['String']>;
  text?: InputMaybe<Scalars['String']>;
};

export type MessageUpdateManyInlineInput = {
  /** Connect multiple existing Message documents */
  ...
  update?: InputMaybe<Array<MessageUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Message documents */
  upsert?: InputMaybe<Array<MessageUpsertWithNestedWhereUniqueInput>>;
};
...
export type MessageUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: MessageUpdateManyInput;
  /** Document search */
  where: MessageWhereInput;
};

export type MessageUpdateOneInlineInput = {
  /** Connect existing Message document */
  connect?: InputMaybe<MessageWhereUniqueInput>;
  /** Create and connect one Message document */
  create?: InputMaybe<MessageCreateInput>;
  /** Delete currently connected Message document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected Message document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single Message document */
  update?: InputMaybe<MessageUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Message document */
  upsert?: InputMaybe<MessageUpsertWithNestedWhereUniqueInput>;
};

export type MessageUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
...
export type MessageUpsertInput = {
  /** Create document if it didn't exist */
...
export type MessageUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: MessageUpsertInput;
  /** Unique document search */
  where: MessageWhereUniqueInput;
};
...
export type Mutation = {
  ...
  /** Delete one chat from _all_ existing stages. Returns deleted document. */
  ...
  /**
   * Delete many Chat documents
   * @deprecated Please use the new paginated many mutation (deleteManyChatsConnection)
   */
  deleteManyChats: BatchPayload;
  /** Delete many Chat documents, return deleted documents */
  deleteManyChatsConnection: ChatConnection;
  /**
  ...
  /**
   * Delete many Message documents
   * @deprecated Please use the new paginated many mutation (deleteManyMessagesConnection)
   */
  deleteManyMessages: BatchPayload;
  /** Delete many Message documents, return deleted documents */
  deleteManyMessagesConnection: MessageConnection;
  /** Delete one message from _all_ existing stages. Returns deleted document. */
  ...
  /**
   * Publish many Chat documents
   * @deprecated Please use the new paginated many mutation (publishManyChatsConnection)
   */
  publishManyChats: BatchPayload;
  /** Publish many Chat documents */
  publishManyChatsConnection: ChatConnection;
  /**
  ...
  /**
   * Publish many Message documents
   * @deprecated Please use the new paginated many mutation (publishManyMessagesConnection)
   */
  publishManyMessages: BatchPayload;
  /** Publish many Message documents */
  publishManyMessagesConnection: MessageConnection;
  /** Publish one message */
  publishMessage?: Maybe<Message>;
  /** Schedule to publish one asset */
  schedulePublishAsset?: Maybe<Asset>;
  /** Schedule to publish one chat */
  schedulePublishChat?: Maybe<Chat>;
  /** Schedule to publish one contact */
  schedulePublishContact?: Maybe<Contact>;
  /** Schedule to publish one message */
  schedulePublishMessage?: Maybe<Message>;
  /** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishAsset?: Maybe<Asset>;
  /** Unpublish one chat from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishChat?: Maybe<Chat>;
  ...
  /** Unpublish one message from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishMessage?: Maybe<Message>;
  /** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishAsset?: Maybe<Asset>;
  /** Unpublish one chat from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishChat?: Maybe<Chat>;
  /** Unpublish one contact from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  ...
  /**
   * Unpublish many Chat documents
   * @deprecated Please use the new paginated many mutation (unpublishManyChatsConnection)
   */
  unpublishManyChats: BatchPayload;
  /** Find many Chat documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyChatsConnection: ChatConnection;
  /**
  ...
  /**
   * Unpublish many Message documents
   * @deprecated Please use the new paginated many mutation (unpublishManyMessagesConnection)
   */
  unpublishManyMessages: BatchPayload;
  /** Find many Message documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyMessagesConnection: MessageConnection;
  /** Unpublish one message from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishMessage?: Maybe<Message>;
  /** Update one asset */
  ...
  /**
   * Update many chats
   * @deprecated Please use the new paginated many mutation (updateManyChatsConnection)
   */
  updateManyChats: BatchPayload;
  /** Update many Chat documents */
  updateManyChatsConnection: ChatConnection;
  /**
   ...
   * @deprecated Please use the new paginated many mutation (updateManyMessagesConnection)
   */
  updateManyMessages: BatchPayload;
  /** Update many Message documents */
  updateManyMessagesConnection: MessageConnection;
  /** Update one message */
...
export type MutationDeleteManyChatsArgs = {
  where?: InputMaybe<ChatManyWhereInput>;
};


export type MutationDeleteManyChatsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationDeleteManyMessagesArgs = {
  where?: InputMaybe<MessageManyWhereInput>;
};


export type MutationDeleteManyMessagesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationPublishManyChatsArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<ChatManyWhereInput>;
};


export type MutationPublishManyChatsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationPublishManyMessagesArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<MessageManyWhereInput>;
};


export type MutationPublishManyMessagesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishChatArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: ChatWhereUniqueInput;
...
export type MutationSchedulePublishMessageArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: MessageWhereUniqueInput;
...
export type MutationScheduleUnpublishChatArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: ChatWhereUniqueInput;
...
export type MutationScheduleUnpublishMessageArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: MessageWhereUniqueInput;
...
export type MutationUnpublishChatArgs = {
  from?: Array<Stage>;
  where: ChatWhereUniqueInput;
};
...
export type MutationUnpublishManyChatsArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<ChatManyWhereInput>;
};


export type MutationUnpublishManyChatsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUnpublishManyMessagesArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<MessageManyWhereInput>;
};


export type MutationUnpublishManyMessagesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUnpublishMessageArgs = {
  from?: Array<Stage>;
  where: MessageWhereUniqueInput;
};
...
export type MutationUpdateManyChatsConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: ChatUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type MutationUpdateManyMessagesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: MessageUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type Query = {
  ...
  chat?: Maybe<Chat>;
  /** Retrieve document version */
  chatVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple chats */
  chats: Array<Chat>;
  /** Retrieve multiple chats using the Relay connection interface */
  ...
  /** Retrieve document version */
  messageVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple messages */
  messages: Array<Message>;
  /** Retrieve multiple messages using the Relay connection interface */
...
export type QueryChatVersionArgs = {
  where: VersionWhereInput;
};
...
export type QueryMessageVersionArgs = {
  where: VersionWhereInput;
};
...
export type ScheduledOperationAffectedDocument = Asset | Chat | Contact | Message;
...
export type CreateNewChatWithNumberMutationVariables = Exact<{
  contactSenderId: Scalars['ID'];
  contactReceiverNumber?: InputMaybe<Scalars['Int']>;
}>;


export type CreateNewChatWithNumberMutation = { __typename?: 'Mutation', createChat?: { __typename?: 'Chat', id: string, contacts: Array<{ __typename?: 'Contact', name: string, profile_picture_url?: string | null, username: string }>, messages: Array<{ __typename?: 'Message', text: string }> } | null };

export type CreateNewChatWithUsernameMutationVariables = Exact<{
  contactSenderId: Scalars['ID'];
  contactReceiverUsername?: InputMaybe<Scalars['String']>;
}>;


export type CreateNewChatWithUsernameMutation = { __typename?: 'Mutation', createChat?: { __typename?: 'Chat', id: string, contacts: Array<{ __typename?: 'Contact', name: string, profile_picture_url?: string | null, username: string }>, messages: Array<{ __typename?: 'Message', text: string }> } | null };
...
export type CreateNewMessageMutation = { __typename?: 'Mutation', createMessage?: { __typename?: 'Message', text: string, contactSenderId: string } | null };
...
export type GetChatByIdQueryQuery = { __typename?: 'Query', chat?: { __typename?: 'Chat', contacts: Array<{ __typename?: 'Contact', id: string, name: string, username: string, profile_picture_url?: string | null, bio?: string | null }>, messages: Array<{ __typename?: 'Message', text: string, contactSenderId: string }> } | null };
...
export type GetContactByNumberQueryQuery = { __typename?: 'Query', contact?: { __typename?: 'Contact', id: string, name: string, username: string, chats: Array<{ __typename?: 'Chat', id: string, contacts: Array<{ __typename?: 'Contact', name: string, profile_picture_url?: string | null }>, messages: Array<{ __typename?: 'Message', text: string }> }> } | null };
...
export type GetContactByUsernameQueryQuery = { __typename?: 'Query', contact?: { __typename?: 'Contact', id: string, name: string, username: string, chats: Array<{ __typename?: 'Chat', id: string, contacts: Array<{ __typename?: 'Contact', name: string, username: string, profile_picture_url?: string | null }>, messages: Array<{ __typename?: 'Message', text: string }> }> } | null };


export const CreateNewChatWithNumberDocument = gql`
    mutation CreateNewChatWithNumber($contactSenderId: ID!, $contactReceiverNumber: Int) {
  createChat(
    data: {contacts: {connect: [{id: $contactSenderId}, {number: $contactReceiverNumber}]}}
  ) {
    id
    contacts {
      name
    ...
    `;
export type CreateNewChatWithNumberMutationFn = Apollo.MutationFunction<CreateNewChatWithNumberMutation, CreateNewChatWithNumberMutationVariables>;

/**
 * __useCreateNewChatWithNumberMutation__
 *
 * To run a mutation, you first call `useCreateNewChatWithNumberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateNewChatWithNumberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createNewChatWithNumberMutation, { data, loading, error }] = useCreateNewChatWithNumberMutation({
 *   variables: {
 *      contactSenderId: // value for 'contactSenderId'
 *      contactReceiverNumber: // value for 'contactReceiverNumber'
 *   },
 * });
 */
export function useCreateNewChatWithNumberMutation(baseOptions?: Apollo.MutationHookOptions<CreateNewChatWithNumberMutation, CreateNewChatWithNumberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateNewChatWithNumberMutation, CreateNewChatWithNumberMutationVariables>(CreateNewChatWithNumberDocument, options);
      }
export type CreateNewChatWithNumberMutationHookResult = ReturnType<typeof useCreateNewChatWithNumberMutation>;
export type CreateNewChatWithNumberMutationResult = Apollo.MutationResult<CreateNewChatWithNumberMutation>;
export type CreateNewChatWithNumberMutationOptions = Apollo.BaseMutationOptions<CreateNewChatWithNumberMutation, CreateNewChatWithNumberMutationVariables>;
export const CreateNewChatWithUsernameDocument = gql`
    mutation CreateNewChatWithUsername($contactSenderId: ID!, $contactReceiverUsername: String) {
  createChat(
    data: {contacts: {connect: [{id: $contactSenderId}, {username: $contactReceiverUsername}]}}
  ) {
    id
    contacts {
      name
    ...
    `;
export type CreateNewChatWithUsernameMutationFn = Apollo.MutationFunction<CreateNewChatWithUsernameMutation, CreateNewChatWithUsernameMutationVariables>;

/**
 * __useCreateNewChatWithUsernameMutation__
 *
 * To run a mutation, you first call `useCreateNewChatWithUsernameMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateNewChatWithUsernameMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createNewChatWithUsernameMutation, { data, loading, error }] = useCreateNewChatWithUsernameMutation({
 *   variables: {
 *      contactSenderId: // value for 'contactSenderId'
 *      contactReceiverUsername: // value for 'contactReceiverUsername'
 *   },
 * });
 */
export function useCreateNewChatWithUsernameMutation(baseOptions?: Apollo.MutationHookOptions<CreateNewChatWithUsernameMutation, CreateNewChatWithUsernameMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateNewChatWithUsernameMutation, CreateNewChatWithUsernameMutationVariables>(CreateNewChatWithUsernameDocument, options);
      }
export type CreateNewChatWithUsernameMutationHookResult = ReturnType<typeof useCreateNewChatWithUsernameMutation>;
export type CreateNewChatWithUsernameMutationResult = Apollo.MutationResult<CreateNewChatWithUsernameMutation>;
export type CreateNewChatWithUsernameMutationOptions = Apollo.BaseMutationOptions<CreateNewChatWithUsernameMutation, CreateNewChatWithUsernameMutationVariables>;
...
export const CreateNewMessageDocument = gql`
  ...
  createMessage(
    data: {text: $messageText, contactSenderId: $contactSenderId, cl5po8uvy2cr601ul2mfa2356: {connect: {id: $chat_id}}}
  ) {
    text
    contactSenderId
  }
...
/**
 * __useGetAllChatsQueryQuery__
 *
 * To run a query within a React component, call `useGetAllChatsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllChatsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllChatsQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllChatsQueryQuery(baseOptions?: Apollo.QueryHookOptions<GetAllChatsQueryQuery, GetAllChatsQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllChatsQueryQuery, GetAllChatsQueryQueryVariables>(GetAllChatsQueryDocument, options);
      }
export function useGetAllChatsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllChatsQueryQuery, GetAllChatsQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllChatsQueryQuery, GetAllChatsQueryQueryVariables>(GetAllChatsQueryDocument, options);
        }
