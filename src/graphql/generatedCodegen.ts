...
export type MessageManyWhereInput = {
  ...
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars["String"]>;
  contactSenderUsername?: InputMaybe<Scalars["String"]>;
  /** All values containing the given string. */
  contactSenderUsername_contains?: InputMaybe<Scalars["String"]>;
  /** All values ending with the given string. */
  contactSenderUsername_ends_with?: InputMaybe<Scalars["String"]>;
  /** All values that are contained in given list. */
  contactSenderUsername_in?: InputMaybe<Array<Scalars["String"]>>;
  /** All values that are not equal to given value. */
  contactSenderUsername_not?: InputMaybe<Scalars["String"]>;
  /** All values not containing the given string. */
  contactSenderUsername_not_contains?: InputMaybe<Scalars["String"]>;
  /** All values not ending with the given string */
  contactSenderUsername_not_ends_with?: InputMaybe<Scalars["String"]>;
  /** All values that are not contained in given list. */
  contactSenderUsername_not_in?: InputMaybe<Array<Scalars["String"]>>;
  /** All values not starting with the given string. */
  contactSenderUsername_not_starts_with?: InputMaybe<Scalars["String"]>;
  /** All values starting with the given string. */
  contactSenderUsername_starts_with?: InputMaybe<Scalars["String"]>;
  createdAt?: InputMaybe<Scalars["DateTime"]>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars["DateTime"]>;
  /** All values greater than or equal the given value. */
...
export enum MessageOrderByInput {
  ContactSenderUsernameAsc = "contactSenderUsername_ASC",
  ContactSenderUsernameDesc = "contactSenderUsername_DESC",
  CreatedAtAsc = "createdAt_ASC",
  CreatedAtDesc = "createdAt_DESC",
  IdAsc = "id_ASC",
  IdDesc = "id_DESC",
...
export const CreateNewMessageDocument = gql`
  mutation CreateNewMessage(
    ...
    createMessage(
      data: {
        text: $messageText
        contactSenderUsername: $contactSenderUsername
